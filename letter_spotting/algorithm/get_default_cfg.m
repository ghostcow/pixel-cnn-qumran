...
sParam.bwMedian = 8.0;                              % threshold at value ( bwMedian * <median value of the image> ) (0.85-0.87 Gniza)
...
sParam.findW = 350;            % bounding box's maximum width
sParam.findH = 400;            % bounding box's maximum height
sParam.findHMin = 40;         % bounding box's minimum heigth
sParam.findWMin = 40;         % bounding box's maximum width
sParam.findT = 15;                          % maximum space between lowest and highest CC in the bounding box
